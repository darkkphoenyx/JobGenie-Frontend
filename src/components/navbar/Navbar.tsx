  ...
  return (
    <>
      <div className="shadow-md top-0 sticky col-span-12 bg-white/70 ">
        <div className="navbar  flex items-center h-20 justify-between px-3 container mx-auto">
          ...
          <div className="nav-login col-span-3">
            <button className="px-4 mr-2 font-semibold rounded-3xl py-2 hover:bg-gray-400/70 ">Login</button>
