    ...
    <div className="testimonial container mx-auto flex items-center justify-center flex-wrap gap-16 py-16 bg-white">
      <div className="left-section w-full sm:w-[400px]">
        ...
        <div className="notice flex flex-col text-center sm:text-left">
          ...
          <Link to={"#"}>
            <button className="mt-5 bg-[--color-text] text-white border border-[--color-text] hover:bg-white hover:text-[--color-text] active:translate-y-1 transition-all font-medium text-sm sm:text-base px-7 py-2 sm:py-3 rounded-3xl">
              More Stories
            </button>
          </Link>
        </div>
