...
//         <div className="bg-white/80 flex flex-col justify-center items-center p-6 md:p-0 shadow-2xl rounded-md md:rounded-r-3xl">
...
//             </div>
//             <RegisterCompoent />
//             <div className="flex items-center justify-center mt-4 font-normal">
...
//           </div>
//         </div>
//         <div className="flex flex-col justify-center items-center p-6 md:px-12 bg-transparent">
